...
return [
    ...
    'db' => [
        ...
        //'password-generator' => Waygou\MultiTenant\Generators\Database\PleskPasswordGenerator::class,
         ...
         */
        'tenant-seed-class' => Waygou\Xheetah\Seeders\CreateSchemaSeeder::class,
